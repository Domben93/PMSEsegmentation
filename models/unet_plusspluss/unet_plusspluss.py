...
from .nd_softmax import softmax_helper, sigmoid_helper
...
import torchvision.models as model_vgg
...
class Generic_UNetPlusPlus(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
                 ...
                 seg_output_use_bias=True, init_encoder=None):
        """
        ...
        self.loc3, self.up3, encoder_features3 = self.create_nest(3, num_pool, encoder_features2, num_conv_per_stage,
                                                                  basic_block, transpconv)
        #elf.loc4, self.up4, encoder_features4 = self.create_nest(4, num_pool, encoder_features3, num_conv_per_stage,
        #                                                          basic_block, transpconv)
        ...
        if init_encoder == 'unet':
            model = torch.load(
                'C:\\Users\\dombe\\PycharmProjects\\Test\\weights\\mateuszbuda-brain-segmentation-pytorch.pt')

            unet = UNet(3, 1, 32)
            unet.init_weights(model['model_state'])

            self.conv_blocks_context[0].blocks[0].conv.weight = unet.encoder1.Conv1.weight
            self.conv_blocks_context[0].blocks[1].conv.weight = unet.encoder1.Conv2.weight
            self.conv_blocks_context[1].blocks[0].conv.weight = unet.encoder2.Conv1.weight
            self.conv_blocks_context[1].blocks[1].conv.weight = unet.encoder2.Conv2.weight
            self.conv_blocks_context[2].blocks[0].conv.weight = unet.encoder3.Conv1.weight
            self.conv_blocks_context[2].blocks[1].conv.weight = unet.encoder3.Conv2.weight
            self.conv_blocks_context[3].blocks[0].conv.weight = unet.encoder4.Conv1.weight
            self.conv_blocks_context[3].blocks[1].conv.weight = unet.encoder4.Conv2.weight

            self.loc0[0][0].blocks[0].conv.weight = unet.decoder4.Conv1.weight
            self.loc0[0][1].blocks[0].conv.weight = unet.decoder4.Conv2.weight
            self.loc1[0][0].blocks[0].conv.weight = unet.decoder3.Conv1.weight
            self.loc1[0][1].blocks[0].conv.weight = unet.decoder3.Conv2.weight
            self.loc2[0][0].blocks[0].conv.weight = unet.decoder2.Conv1.weight
            self.loc2[0][1].blocks[0].conv.weight = unet.decoder2.Conv2.weight
            self.loc3[0][0].blocks[0].conv.weight = unet.decoder1.Conv1.weight
            self.loc3[0][1].blocks[0].conv.weight = unet.decoder1.Conv2.weight

        elif init_encoder == 'vgg':
            vgg_backbone = torch.nn.Sequential(*list(model_vgg.vgg16_bn(weights='DEFAULT').children())[:-2])[0]

            self.conv_blocks_context[0].blocks[0].conv.weight = vgg_backbone[0].weight
            self.conv_blocks_context[0].blocks[1].conv.weight = vgg_backbone[3].weight
            self.conv_blocks_context[1].blocks[0].conv.weight = vgg_backbone[7].weight
            self.conv_blocks_context[1].blocks[1].conv.weight = vgg_backbone[10].weight
            self.conv_blocks_context[2].blocks[0].conv.weight = vgg_backbone[14].weight
            self.conv_blocks_context[2].blocks[1].conv.weight = vgg_backbone[17].weight
            self.conv_blocks_context[3].blocks[0].conv.weight = vgg_backbone[24].weight
            self.conv_blocks_context[3].blocks[1].conv.weight = vgg_backbone[27].weight
            #self.conv_blocks_context[4][0].blocks[0].conv.weight = vgg_backbone[34].weight
            #self.conv_blocks_context[4][1].blocks[0].conv.weight = vgg_backbone[40].weight
    ...
    def forward(self, x):
        ...
        x2_0 = self.conv_blocks_context[2](self.td[0](x1_0))
        ...
        x3_0 = self.conv_blocks_context[3](self.td[0](x2_0))
        ...
        x4_0 = self.conv_blocks_context[4](self.td[0](x3_0))
