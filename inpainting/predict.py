...
def main(args):
    ...
    model = PConvUNet(finetune=False, layer_size=5)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default="C:\\Users\\dombe\\PycharmProjects\\Test\\partial_conv\\ckpt\\0215_1509_56\\models\\1000.pth")
